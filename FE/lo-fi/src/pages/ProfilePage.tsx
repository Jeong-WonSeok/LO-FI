...
export default function ProfilePage() {
  ...
  return (
    <div className="profile-container">
      <h1 className="profile-username">{email} 님</h1>
      <div className="profile-userinfo">
        ...
        <hr />
        <div className="profile-component">잃어버렸어요</div>
        <hr />
        <div className="profile-component">주인을 찾고있어요</div>
        <hr />
        <div className="profile-component">회원정보</div>
        <hr />

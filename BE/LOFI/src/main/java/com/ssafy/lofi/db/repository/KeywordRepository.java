...
public interface KeywordRepository extends JpaRepository<Keyword,Long> {
    ...
    @Query(nativeQuery = true, value = "select distinct a.* FROM (select * from keyword as k wehre k.keyword like :k1) as k1 join " +
    ...
    @Query(nativeQuery = true, value = "select distinct f.* FROM (select * from keyword as k wehre k.keyword like :k1) as k1 join " +
    ...
    @Query(nativeQuery = true, value = "select distinct l.* FROM (select * from keyword as k wehre k.keyword like :k1) as k1 join " +
